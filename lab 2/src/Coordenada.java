...
public class Coordenada {
	...
	public static double distancia(Coordenada c1, Coordenada c2){ //método de clase que calcula la distancia euclideana
		double dis= Math.pow((c2.getX()-c1.getX()),2) + Math.pow((c2.getY()-c1.getY()),2);
		return Math.rint(Math.sqrt(dis)*1000)/1000;	
	}
